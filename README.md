...
- **Diverse Consumer Hardware**: Scales across consumer laptops, gaming desktops, and workstation GPUs, with native support for NVIDIA RTX 30, RTX 40, and RTX 50 series GPUs. This fork also has an additive **Linux AMD ROCm/HIP** path (gfx1201 first; see [docs/amd.md](docs/amd.md)). Native HIP only — not ZLUDA.  
